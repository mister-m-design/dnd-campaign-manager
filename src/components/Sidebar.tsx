...
const NAV_ITEMS = [
    ...
    { name: 'Characters', icon: 'shield_person', href: '/characters/create' },
    ...
    return (
        <aside className="w-64 border-r border-white/5 bg-background-dark/50 backdrop-blur-xl h-screen sticky top-0 flex flex-col pt-8">
            <div className="px-8 mb-12 flex items-center gap-3">
                ...
                <h1 className="text-xl font-black text-slate-100 tracking-tighter uppercase">STITCH<span className="text-primary font-light">DM</span></h1>
            </div>
            ...
            <div className="p-4 border-t border-white/5">
                <div className="flex items-center gap-3 px-4 py-3">
                    <div className="size-8 rounded-full border border-primary overflow-hidden">
                        <img src="https://ui-avatars.com/api/?name=Michael+Murtha&background=f6f6f8&color=0a0c14" alt="User" />
                    </div>
